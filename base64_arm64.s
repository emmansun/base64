...
loop:
	...
	WORD $0x7e202cf0 // VUQSUB V7.B16, V0.B16, V16.B16
	WORD $0x7e212cf1 // VUQSUB V7.B16, V1.B16, V17.B16
	WORD $0x7e222cf2 // VUQSUB V7.B16, V2.B16, V18.B16
	WORD $0x7e232cf3 // VUQSUB V7.B16, V3.B16, V19.B16
	...
	// Get final values:
	VORR V16.B16, B20.B16, V0.B16
	VORR V17.B16, B21.B16, V1.B16
	VORR V18.B16, B22.B16, V2.B16
	VORR V19.B16, B23.B16, V3.B16

	// Check for invalid input, any value larger than 63:
	WORD $0x7e2034f0 // VCMHI V7.B16, V0.B16, B16.B16
	WORD $0x7e2134f1 // VCMHI V7.B16, V1.B16, B17.B16
	WORD $0x7e2234f2 // VCMHI V7.B16, V2.B16, B18.B16
	WORD $0x7e2334f3 // VCMHI V7.B16, V3.B16, B19.B16
