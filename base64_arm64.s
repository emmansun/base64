...
DATA urldec_nibble_const<>+0x00(SB)/8, $0x0F0F0F0F0F0F0F0F // mask_0F
DATA urldec_nibble_const<>+0x08(SB)/8, $0x0F0F0F0F0F0F0F0F
DATA urldec_nibble_const<>+0x10(SB)/8, $0x2F2F2F2F2F2F2F2F // mask_2F
DATA urldec_nibble_const<>+0x18(SB)/8, $0x2F2F2F2F2F2F2F2F
DATA urldec_nibble_const<>+0x20(SB)/8, $0x2804080402011010 // urldec_lut_hi
DATA urldec_nibble_const<>+0x28(SB)/8, $0x1010101010101010
DATA urldec_nibble_const<>+0x30(SB)/8, $0x1111111111111115 // urldec_lut_lo
DATA urldec_nibble_const<>+0x38(SB)/8, $0x331B1A1B1B131111
DATA urldec_nibble_const<>+0x40(SB)/8, $0xB9E0BFBF04110000 // urldec_lut_roll
DATA urldec_nibble_const<>+0x48(SB)/8, $0x00000000000000B9
DATA urldec_nibble_const<>+0x50(SB)/8, $0x5F5F5F5F5F5F5F5F // const_5F
DATA urldec_nibble_const<>+0x58(SB)/8, $0x5F5F5F5F5F5F5F5F
GLOBL urldec_nibble_const<>(SB), (NOPTR+RODATA), $96
...
loop64:
		...
		// Get values from first LUT, then immediately patch in the second LUT.
...
loop64_nibble:
		...
		VTBL V24.B16, [V10.B16], V26.B16
		VTBL V25.B16, [V11.B16], V27.B16
		VORR V27.B16, V26.B16, V3.B16

		// Error check: V0,V1,V2,V3 should be < 64 (0x40)
		MOVD $0x40, R4
		VDUP R4, V7.B16
		WORD $0x6e273c10 // VCMHS V7.B16, V0.B16, V16.B16
		WORD $0x6e273c31 // VCMHS V7.B16, V1.B16, V17.B16
...
TEXT ·decodeURLNibbleAsm(SB),NOSPLIT,$0
	MOVD dst_base+0(FP), R0
	MOVD src_base+24(FP), R1
	MOVD src_len+32(FP), R2

	MOVD $urldec_nibble_const<>(SB), R3
	VLD1.P 16(R3), [V8.B16]   // mask_0F
	VLD1.P 16(R3), [V9.B16]   // mask_2F
	VLD1.P 16(R3), [V10.B16]  // lut_hi
	VLD1.P 16(R3), [V11.B16]  // lut_lo
	VLD1.P 16(R3), [V12.B16]  // lut_roll
	VLD1 (R3), [V13.B16]      // const_5F

loop64_url_nibble:
		CMP $64, R2
		BLT lessThan64_url_nibble
		...
		VTBL V24.B16, [V10.B16], V26.B16
		VTBL V25.B16, [V11.B16], V27.B16
		VORR V27.B16, V26.B16, V16.B16
		WORD $0x6e2d3c9e // VCMHS V13.B16, V20.B16, V30.B16
		VSUB V30.B16, V24.B16, V30.B16
		VTBL V30.B16, [V12.B16], V30.B16
		VADD V30.B16, V16.B16, V0.B16
		...
		VTBL V24.B16, [V10.B16], V26.B16
		VTBL V25.B16, [V11.B16], V27.B16
		VORR V27.B16, V26.B16, V17.B16
		WORD $0x6e2d3cbe // VCMHS V13.B16, V21.B16, V30.B16
		VSUB V30.B16, V24.B16, V30.B16
		VTBL V30.B16, [V12.B16], V30.B16
		VADD V30.B16, V17.B16, V1.B16
		...
		VTBL V24.B16, [V10.B16], V26.B16
		VTBL V25.B16, [V11.B16], V27.B16
		VORR V27.B16, V26.B16, V18.B16
		WORD $0x6e2d3cde // VCMHS V13.B16, V22.B16, V30.B16
		VSUB V30.B16, V24.B16, V30.B16
		VTBL V30.B16, [V12.B16], V30.B16
		VADD V30.B16, V18.B16, V2.B16
		...
		VTBL V24.B16, [V10.B16], V26.B16
		VTBL V25.B16, [V11.B16], V27.B16
		VORR V27.B16, V26.B16, V19.B16
		WORD $0x6e2d3cfe // VCMHS V13.B16, V23.B16, V30.B16
		VSUB V30.B16, V24.B16, V30.B16
		VTBL V30.B16, [V12.B16], V30.B16
		VADD V30.B16, V19.B16, V3.B16
...
loop16_url_nibble:
		...
		WORD $0x6e2d3c9e // VCMHS V13.B16, V0.B16, V30.B16
		VSUB V30.B16, V24.B16, V30.B16
		VTBL V30.B16, [V12.B16], V30.B16
		VADD V30.B16, V0.B16, V0.B16
